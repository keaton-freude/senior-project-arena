        ...
        public Rectangle CollisionRect
        {
            get
            {
                ...
                if (tank_rotation == 0.0 || tank_rotation == 3.14f)
                    toReturn = new Rectangle((int)Position.X - 10, (int)Position.Y-12, (int)(tank_body_texture.Width * scale), (int)(tank_body_texture.Height * scale)-14);
                else if (tank_rotation == 3.14f / 2.0f || true)
                {
                    toReturn = new Rectangle((int)Position.X - 29, (int)Position.Y + 8, (int)(tank_body_texture.Height * scale) - 13, (int)(tank_body_texture.Width * scale));
                }
                return toReturn;
            }
        }
